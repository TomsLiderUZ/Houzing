...
function Category({ title, about, minAbout }) {
  const cardsAbut = [
    { id: "1", name: "House", icon: "/assets/icons/carouselHome.svg", img: "/assets/img/CategoryImg_1.jfif" },
    { id: "2", name: "Apartment", icon: "/assets/icons/carouselApartment.svg", img: "/assets/img/CategoryImg_2.jfif" },
    { id: "3", name: "Office", icon: "/assets/icons/carouselBusinessTrade.svg", img: "/assets/img/CategoryImg_3.jfif" },
    { id: "4", name: "Villa", icon: "/assets/icons/carouselVilla.svg", img: "/assets/img/CategoryImg_4.jfif" },
  ];
