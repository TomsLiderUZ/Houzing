...
function Category({ title, about, minAbout }) {
  const cardsAbut = [
    { id: "1", name: "House", icon: "../../../../public/assets/icons/carouselHome.svg", img: "../../../../public/assets/img/CategoryImg_1.jfif" },
    { id: "2", name: "Apartment", icon: "../../../../public/assets/icons/carouselApartment.svg", img: "../../../../public/assets/img/CategoryImg_2.jfif" },
    { id: "3", name: "Office", icon: "../../../../public/assets/icons/carouselBusinessTrade.svg", img: "../../../../public/assets/img/CategoryImg_3.jfif" },
    { id: "4", name: "Villa", icon: "../../../../public/assets/icons/carouselVilla.svg", img: "../../../../public/assets/img/CategoryImg_4.jfif" },
  ];
