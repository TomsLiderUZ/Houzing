...
function Category({ title, about }) {
  ...
  const cardsAbut = [
    { id: "1", name: "House", icon: "./src/assets/icons/carouselHome.svg", img: "./src/assets/img/CategoryImg_1.png"},
    { id: "2", name: "Apartment", icon: "./src/assets/icons/carouselApartment.svg", img: "./src/assets/img/CategoryImg_2.png"},
    { id: "3", name: "Office", icon: "./src/assets/icons/carouselBusinessTrade.svg", img: "./src/assets/img/CategoryImg_3.png"},
    { id: "4", name: "Villa", icon: "./src/assets/icons/carouselVilla.svg", img: "./src/assets/img/CategoryImg_4.png"},
  ];

  return (
    <div className='CategoryCardCaruselWarpper'>
      ...
      <div className="CategoryCardCaruselCardsBg">
        <div className="CardCaruselUpBottomElement_BtnBG">
          <div className="CardCaruselUpBottomElementButton">{DarkLeftBtnSvg}</div>
        </div>
        <div className="CategoryAllCardItemsBg">
          {cardsAbut.map(card => (
            <div key={card.id} className="CategoryAllCardWrapper" style={{backgroundImage: `url("${card.img}")`}}>
              <div className="CategoryAllCardAsIcon">
                <img src={card.icon} alt="icon" />
              </div>
              <p className="CategoryAllCardAsTitle">{card.name}</p>
            </div>
          ))}
        </div>
        <div className="CardCaruselUpBottomElement_BtnBG">
