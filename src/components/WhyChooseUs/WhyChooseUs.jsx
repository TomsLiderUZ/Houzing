...
function WhyChooseUs({ title, about, minAbout }) {
  const cardsAbut = [
    { id: "1", name: "Trusted By Thousands", about: "With over 1 million+ homes for sale available on the website, Trulia can match you with a house you will want to call home.", icon: "/assets/icons/cardDiscord.svg" },
    { id: "2", name: "Wide Renge Of Properties", about: "With over 1 million+ homes for sale available on the website, Trulia can match you with a house you will want to call home.", icon: "/assets/icons/cardHouse.svg" },
    { id: "3", name: "Financing Made Easy", about: "With over 1 million+ homes for sale available on the website, Trulia can match you with a house you will want to call home.", icon: "/assets/icons/calculator.svg" },
    { id: "4", name: "See Neighborhoods", about: "With over 1 million+ homes for sale available on the website, Trulia can match you with a house you will want to call home.", icon: "/assets/icons/cardMaps.svg" },
  ];
