...
function WhyChooseUs({ title, about, minAbout }) {
  const cardsAbut = [
    { id: "1", name: "Trusted By Thousands", about: "With over 1 million+ homes for sale available on the website, Trulia can match you with a house you will want to call home.", icon: "../../../../public/assets/icons/cardDiscord.svg" },
    { id: "2", name: "Wide Renge Of Properties", about: "With over 1 million+ homes for sale available on the website, Trulia can match you with a house you will want to call home.", icon: "../../../../public/assets/icons/cardHouse.svg" },
    { id: "3", name: "Financing Made Easy", about: "With over 1 million+ homes for sale available on the website, Trulia can match you with a house you will want to call home.", icon: "../../../../public/assets/icons/calculator.svg" },
    { id: "4", name: "See Neighborhoods", about: "With over 1 million+ homes for sale available on the website, Trulia can match you with a house you will want to call home.", icon: "../../../../public/assets/icons/cardMaps.svg" },
  ];
  ...
  return (
    <WhyChooseUsWrapper>
      ...
      <WhyChooseUsCardsBg>
        {cardsAbut.map(card => (
          <WhyChooseUsCardWrapper key={card.id}>
            <WhyChooseUsCardIconBg>
              <img src={card.icon} alt="icon" />
            </WhyChooseUsCardIconBg>
            <WhyChooseUsCardTitleBg>{card.name}</WhyChooseUsCardTitleBg>
            <WhyChooseUsCardAbutBg>{card.about}</WhyChooseUsCardAbutBg>
          </WhyChooseUsCardWrapper>
        ))}
      </WhyChooseUsCardsBg>
    </WhyChooseUsWrapper>
