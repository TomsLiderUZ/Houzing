...
function Index({ title, about, minAbout }) {
  const cardsAbout = [
    { id: "1", name: "Marvin McKinney", rank: "Designer", about: "“ I believe in lifelong learning and Skola is a great place to learn from experts. I've learned a lot and recommend it to all my friends “", logo: "/assets/img/user_avatar_1.png" },
    { id: "2", name: "Marvin McKinney", rank: "Designer", about: "“ I believe in lifelong learning and Skola is a great place to learn from experts. I've learned a lot and recommend it to all my friends “", logo: "/assets/img/user_avatar_1.png" },
    { id: "3", name: "Marvin McKinney", rank: "Designer", about: "“ I believe in lifelong learning and Skola is a great place to learn from experts. I've learned a lot and recommend it to all my friends “", logo: "/assets/img/user_avatar_1.png" },
  ];
