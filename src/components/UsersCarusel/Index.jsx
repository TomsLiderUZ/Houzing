...
function Index({ title, about }) {
  ...
  return (
    <div className="usersCaruselWrapper">
    ...
    <div className="usersCaruselItemsBg">
      <div className="usersCaruselItemRow_1">
        <div className="CardCaruselUpBottomElement_BtnBG">
          <div className="CardCaruselUpBottomElementButton">{DarkLeftBtnSvg}</div>
        </div>
      </div>
      <div className="usersCaruselItemRow_2">
        {cardsAbut.map(card => (
          <div key={card.id} className="usersCaruselItemRowCardWrapper">
            <div className="usersCaruselItemRowCardAvatar">
              <img src={card.logo} alt="logo" />
            </div>
            <div className="usersCaruselItemRowCardTopBg">{card.about}</div>
            <div className="usersCaruselItemRowCardBottomBg">
              <div className="usersCaruselItemRowCardBottomNameBg">{card.name}</div>
              <div className="usersCaruselItemRowCardBottomRankBg">{card.rank}</div>
            </div>
          </div>
        ))}
      </div>
