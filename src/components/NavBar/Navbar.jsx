...
function Navbar() {
  ...
  useEffect(() => {
    ...
    const userAccountLog = decryptedAccounts.find(
  ...
  return (
    <div className="Container">
      ...
      <div
        className="NavItemsBgLinksBgMobileWrapper"
        style={{
          opacity: navActive ? "1" : "0",
          marginTop: navActive ? "0px" : "-1000px",
        }}
      >
        <div className="NavItemsBgLinksBgMobileTop">
          <button
            className="NavItemsBgLinksBgMobileCloseBtn"
            onClick={changeNavMenu}
          >
        ...
        <div className="NavItemsBgLinksBgMobileBottomWrapper">
          <div className="NavItemsBgLinksBgMobileBottom">
            <div className="NavItemsBgLinksBgMobileLinksWrapper">
              <Link className="NavItemsBgLinksBgMobileLinkBg" to="/home">
                Home
              </Link>
              <Link className="NavItemsBgLinksBgMobileLinkBg" to="/properties">
                Properties
              </Link>
              <button
                className="NavItemsBgLinksBgMobileLinkBg"
            ...
            <div className="NavItemsBgLinksBgMobileLinkMoresWrapper">
              <a href="/" className="NavItemsBgLinksBgMobileLinkMoreItemBg">
                <img src="/assets/icons/facebookDark.svg" alt="Facebook" />
              </a>
              <a href="/" className="NavItemsBgLinksBgMobileLinkMoreItemBg">
                <img src="/assets/icons/twitterDark.svg" alt="Twitter" />
              </a>
              <a href="/" className="NavItemsBgLinksBgMobileLinkMoreItemBg">
                <img src="/assets/icons/instagramDark.svg" alt="Instagram" />
              </a>
              <a href="/" className="NavItemsBgLinksBgMobileLinkMoreItemBg">
                <img src="/assets/icons/linkedinDark.svg" alt="LinkedIn" />
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="NavWrapper">
        ...
        <div className="NavItemsBg NavItemsBgLink">
          ...
          <Link
            to="/properties"
            className="NavItemLinks"
            style={{ color: propertiesColor }}
          >
            Properties
          </Link>
          <button className="NavItemLinks" onClick={scrollToBottom}>
            Contacts
          </button>
        </div>
        {accauntActiveInfo ? (
          <div className="NavItemsBgProfile">
            <Link
              to={"/user/me"}
              className="NavItemsBgProfileOpenBtn"
              style={{
                backgroundColor:
                  imgActive || bannedActive ? "black" : backgroundColor,
                backgroundImage: `url("${
                  bannedActive ? "../../src/assets/img/banned.jpg" : imgSrc
                }")`,
              }}
            >
          ...
          <>
            ...
            <div
              className="NavItemsBgJoinMobile"
              style={{ display: showButton2 ? "flex" : "none" }}
            >
              <Link to="/user/login" className="NavItemsBgJoinIcon">
                <img
                  src="/assets/img/loginOpen.png"
                  alt="Login icon"
                  className="NavItemsBgJoinIcon"
                />
              </Link>
            </div>
          </>
