    ...
    <div className='homeContentWrapper'>
      ...
      <div className="homeContentTopCaruselWrapper">
        ...
        <div className="homeContentTopCaruselImg">
          <img src="./src/assets/img/carusel_img_1.png" alt="img" width="100%" height="571px" className='homeContentTopCaruselItemImg' style={{ opacity: carusel === 1 ? "1" : "0" }} />
          <img src="./src/assets/img/carusel_img_2.png" alt="img" width="100%" height="571px" className='homeContentTopCaruselItemImg' style={{ opacity: carusel === 2 ? "1" : "0" }} />
          <img src="./src/assets/img/carusel_img_3.png" alt="img" width="100%" height="571px" className='homeContentTopCaruselItemImg' style={{ opacity: carusel === 3 ? "1" : "0" }} />
          <img src="./src/assets/img/carusel_img_4.png" alt="img" width="100%" height="571px" className='homeContentTopCaruselItemImg' style={{ opacity: carusel === 4 ? "1" : "0" }} />
          <img src="./src/assets/img/carusel_img_2.png" alt="img" width="100%" height="571px" className='homeContentTopCaruselItemImg' style={{ opacity: carusel === 5 ? "1" : "0" }} />
          <img src="./src/assets/img/carusel_img_3.png" alt="img" width="100%" height="571px" className='homeContentTopCaruselItemImg' style={{ opacity: carusel === 6 ? "1" : "0" }} />
        </div>
