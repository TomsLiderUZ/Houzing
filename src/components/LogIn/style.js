...
export const ContainerCardChekWrapper = styled.div`
    width: 100%;
    height: max-content;
    margin-top: 17px;
    display: flex;
...
export const ContainerCardChekWrapperLeftItem = styled.div`
    width: 50%;
    height: max-content;
    display: flex;
    justify-content: left;
...
export const ContainerCardChekBox = styled.input`
    width: 18px;
    height: 18px;
    cursor: pointer;
...
export const ContainerCardChekTitle = styled.p`
    width: max-content;
    height: max-content;
    font-size: 14px;
    font-weight: 400;
...
export const ContainerCardChekWrapperRightItem = styled.div`
    width: 50%;
    height: max-content;
    display: flex;
...
export const ContainerCardChekLinkBg = styled.div`
    width: max-content;
    height: max-content;
